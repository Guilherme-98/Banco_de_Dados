...
<body>
	...
	<div class="container">
		<div class="col-12">
			<h1 style="text-align: center">Filtro de Preços</h1>
			<br>
			...
			<div class="container" style="display: grid; grid-template-columns: 1fr 1fr 1fr;">
				<c:forEach var="iphone" items="${requestScope.iphoneList}" begin="0" varStatus="i">		
							...
							<a style="text-decoration: none; color: black;"
								...
								<div class="card-body" style="background-color: #DDDAD5">
									...
									<p>
										<c:choose>
											<c:when test="${!i.last}">
												<c:out value="Valor: R$ ${requestScope.precosFiltro.get(i.count - 1).getPreco_atual()} - Data: ${requestScope.precosFiltro.get(i.count - 1).getData_preco()}"></c:out>
											</c:when>
											<c:otherwise>
												<c:out value="Valor: R$ ${requestScope.precosFiltro.get(i.count - 1).getPreco_atual()} - Data: ${requestScope.precosFiltro.get(i.count - 1).getData_preco()}"></c:out>
											</c:otherwise>
